                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a class="btn btn-sm btn-danger hapusFasilitasBaru " data-id="{{$fb->id}}">Hapus</a>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form method="post" action="{{route('updateFasilitasBaru')}}" onkeydown="return event.key != 'Enter';">
                    @csrf
                    <div class="form-group">
